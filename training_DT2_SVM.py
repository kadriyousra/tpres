...
# Création et entraînement du modèle SVM calibré
base_svm = LinearSVC(dual=False, random_state=42, max_iter=10000)
model = CalibratedClassifierCV(base_svm)  # Calibrer pour obtenir des probabilités
...
# Calcul et affichage des métriques pour chaque classe
